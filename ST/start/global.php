...
ClassLoader::addDirectories(array(
    ...
    app_path() . '/libraries',
    app_path() . '/libraries/Helpers/Misc',
    app_path() . '/commands',
...
App::down(function () {
    ...
    $allowedIp = ['93.76.199.131'];
    if (!in_array($ip, $allowedIp))
        return Response::make(View::make('down'), 503);
});


App::missing(function ($exception) {
    $layout = View::make('frontend.layouts.site');
    $breadcrumbs = [
        ['link' => '#', 'title' => "NOT FOUND 404"],
    ];

    View::share('breadcrumbs', $breadcrumbs);
    $layout->content = View::make('frontend.global.hard-404');
    $layout->mainmenu = View::make('frontend.global.mainmenu');
    // View::make('frontend.layouts.fullwidth');
