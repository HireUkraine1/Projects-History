...
return [
    ...
    */
    ...
    'check_uri'            => 'Поле :attribute должно быть существующим URI.',
    'protected_uri'        => 'Поле :attribute защищенный URI.',
    ...
    */
    ...
    'custom' => [
        'newurl' => [
            'check_uri' => 'Поле :attribute должно быть существующим URI (или URL начинающимся с http://)',
        ],
        'attribute-name' => [
        ...
        'newurl' => [
            'unique' => 'Такое значение поля :attribute уже используется для oldurl, не используйте больше одного редиректа.'
        ],
        'url' => [
            'regex' => 'Поле :attribute должно начинаться с / символа.',
        ]
    ],
