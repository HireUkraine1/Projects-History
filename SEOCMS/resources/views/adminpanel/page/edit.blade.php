<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title">{{ __('adminpanel/adminpanel.page.edit') }}</h4>
        </div>
        <div class="modal-body">
            <div id="error" class="alert alert-danger hide">
            </div>
            <form id="form-edit-page" data-page-id="{{ $page->id }}" class="form-horizontal form-label-left">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 col-xs-12">
                            <select id="template_id"
                                    ...
                                    name="template_id"
                                    required>
                                <option selected value="{{ $page->template_id }}">{{ $page->template->name }}</option>
                            </select>
                    ...
                    <div class="col-sm-9 col-xs-12">
                        <select id="sitemappriority"
                            ...
                            @for($i = 0.1; $i <= 1; $i = $i + 0.1)
                                <option {{ ($page->sitemappriority == $i.'') ? 'selected' : '' }} value="{{$i}}">{{$i}}</option>
                            @endfor
                        </select>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        <textarea id="criticalcss" required="required" class="form-control textarea" name="criticalcss"
                                  rows="20">{{ $page->criticalcss }}</textarea>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        <input id="active" class="form-check-input" name="active" type="checkbox"
                                {{ $page->active ? 'checked' : '' }}>
                    </div>
                </div>
            </form>
        ...
        <div class="modal-footer">
            ...
            <a type="button" class="btn btn-primary" id="update-page"
