...
<?php } ?>
    ...
    <div class="simplecheckout-button-block buttons" id="step_buttons">
        <div class="simplecheckout-button-right">
            <a class="buy nbut" onclick="simplecheckout_next();" id="simplecheckout_next"><span><?php echo $button_next; ?></span></a>
        </div>
        <div class="simplecheckout-button-left">
            <a class="buy nbut" onclick="simplecheckout_prev()" id="simplecheckout_prev"><span><?php echo $button_prev; ?></span></a>
        </div>
    </div>
    <?php } ?>
    <div class="simplecheckout-button-block buttons" id="buttons" <?php if ($block_order) { ?>style="display:none;"<?php } ?>>
        <div class="simplecheckout-button-left">
            <?php if ($simple_common_view_agreement_checkbox) { ?><label><input type="checkbox" id="agree" name="agree" value="1" <?php if ($agree == 1) { ?>checked="checked"<?php } ?> /><?php echo $text_agree; ?></label>&nbsp;<?php } ?><a class="buy nbut" onclick="simplecheckout_submit();" id="simplecheckout_button_confirm"><span><?php echo $button_order; ?></span></a>
        </div>
        <?php if ($simple_show_back) { ?>
        <div class="simplecheckout-button-left">
            <a class="buy nbut" onclick="history.go(back_count)"><span><?php echo $button_back; ?></span></a>
        </div>
        <?php } ?>
    </div>
    </div>
