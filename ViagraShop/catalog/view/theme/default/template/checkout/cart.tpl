<?php echo $header; ?>
<?php if ($attention) { ?>
<div class="attention"><div class="container"><?php echo $attention; ?><img src="catalog/view/theme/default/image/close.png" alt="" class="close" /></div></div>
<?php } ?>
<?php if ($success) { ?>
<div class="success"><div class="container"><?php echo $success; ?><img src="catalog/view/theme/default/image/close.png" alt="" class="close" /></div></div>
<?php } ?>
<?php if ($error_warning) { ?>
<div class="warning"><div class="container"><?php echo $error_warning; ?><img src="catalog/view/theme/default/image/close.png" alt="" class="close" /></div></div>
<?php } ?>
		...
		success: function(json) {
			...
			if (json['error']) {
				if (json['error']['warning']) {
					$('#notification').html('<div class="warning" style="display: none;"><div class="container">' + json['error']['warning'] + '<img src="catalog/view/theme/default/image/close.png" alt="" class="close" /></div></div>');
