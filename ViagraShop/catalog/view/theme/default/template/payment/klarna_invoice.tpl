...
$('#button-confirm').on('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#payment').before('<div class="attention"><div class="container"><img src="catalog/view/theme/default/image/loading.gif" alt="" /> <?php echo $text_wait; ?></div></div>');
		},
		complete: function() {
		...
		success: function(json) {	
			if (json['error']) {
				$('#payment').before('<div class="warning"><div class="container">' + json['error'] + '</div></div>');
			}
