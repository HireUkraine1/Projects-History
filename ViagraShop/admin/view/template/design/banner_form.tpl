        ...
        <table id="images" class="list">
          <thead>
            <tr>
              ...
              <td class="left"><?php echo $entry_desc1; ?></td>
          ...
          <tbody id="image-row<?php echo $image_row; ?>">
            <tr>
			  ...
			  <td class="left"><textarea name="banner_image[<?php echo $image_row; ?>][desc1]"><?php echo $banner_image['desc1']; ?></textarea></td>
...
function addImage() {
	...
	html += '<td class="left"><textarea name="banner_image[' + image_row + '][desc1]"></textarea></td>';
